module Effective
  class PollQuestion < ActiveRecord::Base
    ...
    accepts_nested_attributes_for :poll_question_options, allow_destroy: true

    has_rich_text :body

    CATEGORIES = [
      'Choose one',   # Radios
      'Select all that apply', 'Select upto 1', 'Select upto 2', 'Select upto 3', 'Select upto 4', 'Select upto 5', # Checks
      'Date',         # Date Field
      'Email',        # Email Field
